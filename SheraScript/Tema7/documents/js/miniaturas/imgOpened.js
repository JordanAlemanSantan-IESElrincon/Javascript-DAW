...
contenidoImagenCompleta.innerHTML =
    `
        ...
        <img src="${location.search.substring(location.search.indexOf("=") + 1, location.search.length)}" alt="${location.search.substring(location.search.indexOf("/") + 1, location.search.indexOf("."))}">
    `;
